...
Здесь, в поле **"Repository name"** необходимо ввести имя репозитория (то, как вы хотите его назвать), после чего выбрать будет ли ваш репозиторий публичным или приватным и нажать на зеленую кнопку **"Create repository"**.
Сделав это, перед нами появится следующая вкладка, где GitHub подскажет нам дальнейшие действия.
...
```
Совершив все эти действия, мы связали наши локальный и удаленный репозитории, и теперь можем с ними работать.
